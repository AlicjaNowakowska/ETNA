...
class GUI_for_network_analysis:
  def __init__(self):
    ...
    #self.robustness_random_label.layout.visibility = 'hidden' WROC
    ...
    #self.robustness_random_value.layout.visibility = 'hidden' WROC
  ...
  def cascade_button_click(self, b):
    ...
    Binds robustness button with the rd (1) and then plotted (2).
